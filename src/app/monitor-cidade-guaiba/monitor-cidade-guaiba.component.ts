...
@Component({
  ...
  styleUrl: './monitor-cidade-guaiba.component.css',
...
export class MonitorCidadeGuaibaComponent implements OnInit{
  ...
  public cidadeGuaibaService = inject(SaladesituacaoServiceService)
  public cidadeGuaibaData: GuaibaInfo[] = [];
...
ngOnInit(){
  this.cidadeGuaibaService.cidadeGuaibaData().subscribe(
    data => {
      this.parseData(data)
      this.getLastValues()    
    })
