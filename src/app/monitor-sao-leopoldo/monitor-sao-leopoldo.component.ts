...
@Component({
  ...
  styleUrl: './monitor-sao-leopoldo.component.css',
...
export class MonitorSaoLeopoldoComponent implements OnInit{
  ...
  public saoLepoldoervice = inject(SaladesituacaoServiceService)
  public saoLeopoldoData: GuaibaInfo[] = [];
...
ngOnInit(){
  this.saoLepoldoervice.campoBomData().subscribe(
    data => {
      this.parseData(data)
      this.getLastValues()    
    })
